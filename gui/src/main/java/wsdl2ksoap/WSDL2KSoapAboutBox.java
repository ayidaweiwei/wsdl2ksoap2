...
public class WSDL2KSoapAboutBox extends javax.swing.JDialog {

    public WSDL2KSoapAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(wsdl2ksoap.WSDL2KSoapApp.class).getContext().getResourceMap(WSDL2KSoapAboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(wsdl2ksoap.WSDL2KSoapApp.class).getContext().getActionMap(WSDL2KSoapAboutBox.class, this);
